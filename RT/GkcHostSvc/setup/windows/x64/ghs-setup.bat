...
rem
rem create service
sc create GkcHostSvc binPath= "C:\program files\.GKC\GKC-1.0.1-win64\public\assemblies\GkcHostSvc.exe" DisplayName= "GKC Host" type= own start= auto obj= LocalSystem
sc start GkcHostSvc
sc query GkcHostSvc
