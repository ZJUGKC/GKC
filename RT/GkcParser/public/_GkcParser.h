...
public:
	...
	virtual void SetInput(const GKC::ShareCom<GKC::ITextStreamRoot>& sp) throw() = 0;
...
BEGIN_ENUM(_WonTokenTypes)
	...
	ENUM_VALUE_ENTRY(EndPair, 12)
	ENUM_VALUE_ENTRY(BeginArray, 13)
	ENUM_VALUE_ENTRY(EndArray, 14)
