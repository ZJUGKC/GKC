...
rem
rem create service
sc create GkcScheduleSvc binPath= "C:\program files\.GKC\GKC-1.0.1-win64\\public\assemblies\GkcScheduleSvc-1-0.exe" DisplayName= "GKC Schedule" type= own start= auto obj= LocalSystem
