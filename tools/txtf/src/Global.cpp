...
BEGIN_STATIC_CONST_ARRAY(g_const_array_help)
	...
	STATIC_CONST_ARRAY_ENTRY(IMPLEMENT_CONST_STRING_ENTRY(CharS, _S("            sub-functions: -g [-rtl] <charset string> Generate the complete github-style html file.")))
	STATIC_CONST_ARRAY_ENTRY(IMPLEMENT_CONST_STRING_ENTRY(CharS, _S("                              -rtl: Specify the html right-to-left direction.")))
	STATIC_CONST_ARRAY_ENTRY(IMPLEMENT_CONST_STRING_ENTRY(CharS, _S("                              The charset string specifies the character set, such as UTF-8.")))
	STATIC_CONST_ARRAY_ENTRY(IMPLEMENT_CONST_STRING_ENTRY(CharS, _S("                           -x [-rtl] [-l] <language> <css-file> Generate the complete xhtml file.")))
	STATIC_CONST_ARRAY_ENTRY(IMPLEMENT_CONST_STRING_ENTRY(CharS, _S("                              -rtl: Specify the html right-to-left direction.")))
